...
addon-test:		## Run jest tests for the addon
	cd ../../ && CI=true RAZZLE_JEST_CONFIG=src/addons/volto-eea-chatbot/jest-addon.config.js yarn test $(TEST_FILE) --watchAll=false --reporters=default --reporters=jest-junit --collectCoverage
